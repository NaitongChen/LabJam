...
insert into Fund_ApprovedGrant values
('AllerGen 2016 Gryffindor',35690.2,'Murtlap');
...
insert into Fund_ApprovedGrant values
('Physics YAY',50000,'Bring Back Spider-Man');
...
insert into Fund_ApprovedGrant values
('International Agriculture Funds 2017',40000,'Corn DNA sequence');
...
insert into Fund_ApprovedGrant values
('Poor Draco 2017',34900.8,'post-voldemort trauma');
insert into Fund_ApprovedGrant values
...
insert into Fund_ApprovedGrant values
('Machine Learing and Genetics',20000,'ML for Genetics');
...
insert into Fund_ApprovedGrant values
('Social Award',10000,'Housing in Vancouver');
...
('8926','Tech');
insert into Contains_LabMember values
('8881','0010','She Gone','Biology','7789981865');
insert into Researcher values
('8881','Wet Lab');
insert into Contains_LabMember values
('8882','0010','Hee Gone','Biology','7789982865');
insert into Researcher values
('8882','Data');
insert into Project_MaterialType values
...
('Yeast Culture',120);
insert into Applies_OpenGrant_Date values
('Canada Yeast Fund 2018',10000,TO_DATE('14/10/2018', 'DD/MM/YYYY'),'pending');
insert into Date_Name_Lmid values
('Canada Yeast Fund',TO_DATE('14/10/2018', 'DD/MM/YYYY'),'8924');
insert into Supervises_WorksOn values
('Yeet the yeasts','8926','8925','lead researcher');
insert into Supervises_WorksOn values
('Yeet the yeasts','8881','8925','Co-op Student');
insert into Role_WeeklyHoursAllocated values
('Co-op Student',33);
insert into Supervises_WorksOn values
('Yeet the yeasts','8882','8925','Volunteer Student');
insert into Role_WeeklyHoursAllocated values
('Volunteer',5);
insert into Fund_ApprovedGrant values
('Canada Yeast Fund 2017',30000,'Yeet the yeasts');
...
insert into Takes_Booking values
('Conversations with Merpeople',1,100,'Control Group');
insert into Takes_Booking values
('Conversations with Merpeople',2,100,'Control Group');
insert into Takes_Booking values
('Conversations with Merpeople',3,100,'Experimental Group');
insert into Takes_Booking values
('Conversations with Merpeople',4,100,'Experimental Group');
insert into Takes_Booking values
('De-depress Demontors',1,100,'Control Gorup');
insert into Takes_Booking values
