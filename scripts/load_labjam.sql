...
('1111','0001','Harry Patter','Zoology');
insert into Contains_LabMember values
('1112','0001','Shermione Granger','Genetics');
insert into Contains_LabMember values
('1113','0001','Don Weasley','Zoology');
insert into Contains_LabMember values
('1114','0001','Pat Weasley','Accounting');
insert into Contains_LabMember values
('1115','0001','Severus Shape','Zoology');
...
insert into Supervises_WorksOn values
('Save The Hippogriffs','1113','1115','second assisting researcher');
insert into Supervises_WorksOn values
...
insert into Contains_LabMember values
('1121','0002','Harry Patter','Psychology');
insert into Contains_LabMember values
('1122','0002','Shermione Lranger','Psychology');
insert into Contains_LabMember values
('1123','0002','Don Keasley','Statistics');
insert into Contains_LabMember values
('1124','0002','John Smith','English');
insert into Contains_LabMember values
('1125','0002','Charity Burbage','Psychology');
insert into LabManager values
('1124','full time');
insert into PI values
('1125','Psychology');
...
insert into Contains_LabMember values
('1221','0003','Iron Man','Physics');
insert into Contains_LabMember values
('1222','0003','Blank Panther','Maths');
insert into Contains_LabMember values
('1223','0003','Black Widow','Physics');
insert into LabManager values
('1222','full time');
insert into PI values
('1223','Physics');
...
insert into Supervises_WorksOn values
('Bring Back Spider-Man','1221','1123','urgent lead researcher');
insert into Role_WeeklyHoursAllocated values
('urgent lead researcher',168);
insert into Supervises_WorksOn values
('Time and Space Paradox','1221','1123','lead researcher');
insert into MaterialType_MaterialPrice values
...
insert into Contains_LabMember values
('1300','0004','Blossom Powerpuff','Biology');
insert into Contains_LabMember values
('1301','0004','Bubbles Powerpuff','Biology');
insert into Contains_LabMember values
('1302','0004','Buttercup Powerpuff','Biology');
insert into LabManager values
('1300','part time');
insert into PI values
('1301','Biology');
...
insert into Contains_LabMember values
('8908','0005','Chuyi Guang','Psychology');
insert into LabManager values
('8908','full time');
insert into Contains_LabMember values
('8910','0005','Draco Lucius Nalfoy','Psychology');
insert into PI values
('8910','Psychology');
insert into Contains_LabMember values
('8911','0005','Lol Yeet','Statistics');
insert into Researcher values
('8911','Data');
insert into Project_MaterialType values
...
insert into Contains_LabMember values
('8912','0006','Ray Li','Biology');
insert into LabManager values
('8912','full time');
insert into Contains_LabMember values
('8913','0006','Mia Jones','Biology');
insert into PI values
('8913','Biology');
insert into Contains_LabMember values
('8914','0006','Lol Yeetz','Biology');
insert into Researcher values
('8914','Tech');
insert into Project_MaterialType values
...
insert into Contains_LabMember values
('8915','0007','Caitlyn Brown','Statistics');
insert into LabManager values
('8915','part time');
insert into Contains_LabMember values
('8916','0007','Nya Coppers','Statistics');
insert into PI values
('8916','Statistics');
insert into Contains_LabMember values
('8917','0007','Lmao Yeetz','Computer Science');
insert into Researcher values
('8917','Tech');
insert into Project_MaterialType values
...
insert into Contains_LabMember values
('8918','0008','Jiali Zhang','Statistics');
insert into LabManager values
('8918','full time');
insert into Contains_LabMember values
('8919','0008','World Gregor','Computer Science');
insert into PI values
('8919','Machine Learning');
insert into Contains_LabMember values
('8920','0008','Dab Hard','Computer Science');
insert into Researcher values
('8920','Data');
insert into Project_MaterialType values
...
insert into Contains_LabMember values
('8921','0009','Anna Ivanovic','Statistics');
insert into LabManager values
('8921','full time');
insert into Contains_LabMember values
('8922','0009','Nojak Djokovic','Political Science');
insert into PI values
('8922','Political Science');
insert into Contains_LabMember values
('8923','0009','John Isnar','History');
insert into Researcher values
('8923','Data');
insert into Project_MaterialType values
...
insert into Contains_LabMember values
('8924','0010','Stefanas Tsitsipas','Accounting');
insert into LabManager values
('8924','full time');
insert into Contains_LabMember values
('8925','0010','Haoran Wang','Microbiology');
insert into PI values
('8925','Microbiology');
insert into Contains_LabMember values
('8926','0010','Karoline Wozniacki','Microbiology');
insert into Researcher values
('8926','Tech');
insert into Project_MaterialType values
