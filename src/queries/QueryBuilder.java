...
public class QueryBuilder {
	...
	public static int totalFunding = 0;
	public static float materialPrice = 0;
	...
	public static void setTotalFunding(int funding) {
		totalFunding = funding;
	}
	
	public static void setMaterialPrice(float mPrice) {
	...
	public static String countControlExperimental() {
		return "Select participanttestcondition, cast(count(*) as int) as count from Takes_Booking where projectName = '" + projectName + "' "+ 
				"group by participanttestcondition " + "order by participanttestcondition";
	}
	
	public static String calculateTotalFunding() {
		return "Select cast(SUM(amount) as int) as total " +
	...
	// public static String insertSubjects(Integer sid_input, String name_input, String availability_input) {
	// 	return "insert into " +
	// 			"from Fund_ApprovedGrant fa " +
	// 			"where fa.projectName = '" + 
	// 			projectName_input + "'";
